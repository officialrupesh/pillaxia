        ...
        <div className="container">
          <section className="hero-section-container row me-0">
            <div className="col-12 col-lg-8">
              <ScrollAnimation className="d-flex"  animateIn="slideInDown" duration={2} delay={3}>
              ...
              <ScrollAnimation   animateIn="bounceInLeft" duration={2} delay={3}>
                <a href="#">
              ...
              <ScrollAnimation  initiallyVisible={true} delay={3}>
            ...
            <ScrollAnimation  animateIn="bounceInDown" duration={2} delay={3} className="col-12 col-lg-4 d-lg-block d-none">
